...
func SignUpPage() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<h2>SignUpPage</h2><form hx-post=\"/api/sign-up\" hx-target=\"#response\"><div><label for=\"email\">Email:</label> <input type=\"email\" id=\"email\" name=\"email\" required></div><div><label for=\"firstName\">Firstname:</label> <input type=\"firstName\" id=\"firstName\" name=\"firstName\" required></div><div><label for=\"lastName\">Lastname:</label> <input type=\"lastName\" id=\"lastName\" name=\"lastName\" required></div><div><label for=\"password\">Password:</label> <input type=\"password\" id=\"password\" name=\"password\" required></div><button type=\"submit\">Sign Up</button></form><div id=\"response\"></div>")
			if templ_7745c5c3_Err != nil {
